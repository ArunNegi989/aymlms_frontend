...
// ---- Auto-generated details for the "All Courses" listing page (12 courses) ----
// Ids are prefixed "list-c" to avoid colliding with the "1"/"2"/"3" hand-written
// entries above and with the "all-c*" / "trend-c*" homepage ids.
const listCoursesSummaries: SummaryInput[] = [
  {
    id: "list-c1",
    title: "200 Hour Yoga Teacher Training",
    ...
    students: "1,240",
    tagline:
      "Complete teacher training program covering asanas, philosophy, anatomy, and teaching methodology.",
  ...
  },
  {
    ...
    reviews: 340,
    students: "3,400",
    tagline: "Learn the fundamentals of Hatha Yoga including asanas, pranayama, and meditation.",
    category: "Yoga",
    level: "beginner",
    duration: "40 hours",
  },
  {
    ...
    reviews: 185,
    students: "1,850",
    tagline: "Master dynamic Vinyasa sequences with proper alignment and breathing techniques.",
    category: "Yoga",
    level: "intermediate",
    duration: "60 hours",
  },
  {
    ...
    students: "5,600",
    tagline:
      "Discover the art of meditation and mindfulness for inner peace and mental clarity.",
    category: "Meditation",
    level: "all",
    duration: "15 hours",
  },
  {
    ...
    reviews: 270,
    students: "2,700",
    tagline: "Master the ancient science of pranayama for physical and mental well-being.",
    category: "Pranayama",
    level: "beginner",
    duration: "25 hours",
  },
  {
    ...
    reviews: 89,
    students: "890",
    tagline: "Explore the philosophical foundations of yoga including Patanjali's Yoga Sutras.",
  ...
  },
  {
    ...
    students: "1,200",
    tagline:
      "Understand the human body's anatomy and physiology for safe and effective yoga practice.",
    category: "Anatomy",
    level: "intermediate",
    duration: "80 hours",
  },
  {
    ...
    reviews: 95,
    students: "950",
    tagline: "Foundation teacher training program for aspiring yoga teachers.",
    category: "Teacher Training",
    level: "beginner",
    duration: "100 hours",
  },
  {
    ...
    reviews: 780,
    students: "7,800",
    tagline: "Start your yoga journey with this comprehensive beginner-friendly course.",
    category: "Yoga",
    level: "beginner",
    duration: "20 hours",
  },
  {
    ...
    reviews: 65,
    students: "650",
    tagline: "Master advanced yoga poses with proper alignment and technique.",
    category: "Yoga",
    level: "advanced",
    duration: "35 hours",
  },
  {
    ...
    reviews: 420,
    students: "4,200",
    tagline: "Discover yoga practices for mental health, stress relief, and overall wellness.",
    category: "Wellness",
    level: "all",
    duration: "45 hours",
  },
  {
    ...
    reviews: 52,
    students: "520",
    tagline: "Advanced teacher training program for experienced yoga teachers.",
    category: "Teacher Training",
    level: "advanced",
    duration: "300 hours",
  },
...
[...allCoursesSummaries, ...trendingSummaries, ...listCoursesSummaries].forEach((s) => {
